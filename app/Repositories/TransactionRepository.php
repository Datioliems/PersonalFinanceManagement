...
class TransactionRepository extends BaseRepository
{
     ...
     */
    public function countFiltered(int $userId, string $type = '', string $filterMonth = '', int $categoryId = 0): int
    {
     ...
     * Dùng cho bảng tóm tắt ngày trong transactions/index.php
     */
    public function getDailySummary(int $userId, string $yearMonth): array
    {
        $stmt = $this->db->prepare(
            "SELECT trans_date,
             ...
             FROM transactions
             WHERE user_id = :uid AND DATE_FORMAT(trans_date,'%Y-%m') = :ym
