...
<div class="d-flex align-items-center gap-2 mb-4">
    <a href="<?= BASE_URL ?>/incomes" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left"></i></a>
    <h2 class="h4 fw-semibold mb-0">Sửa thu nhập</h2>
</div>
<div class="card shadow-sm">
<div class="card-body p-4">
<form method="POST" action="<?= BASE_URL ?>/incomes/<?= (int)$tx['id'] ?>">
    ...
    <div class="mb-3">
        ...
        <div class="input-group">
            <span class="input-group-text bg-white text-success"><i class="bi bi-plus-circle"></i></span>
